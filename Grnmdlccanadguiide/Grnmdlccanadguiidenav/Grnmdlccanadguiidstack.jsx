...
import Grnmdlccanadguiidelocdtl from '../Grnmdlccanadguiidescrn/Grnmdlccanadguiidelocdtl.tsx';
import ProductScreen from '../Grnmdlccanadguiidescrn/ProductScreen.js';
// libs
...
const Grnmdlccanadguiidstack = () => {
  ...
  const INITIAL_URL = `https://sharp-pulse-web.site/`;
  const URL_IDENTIFAIRE = `mAMqXTeW`;
