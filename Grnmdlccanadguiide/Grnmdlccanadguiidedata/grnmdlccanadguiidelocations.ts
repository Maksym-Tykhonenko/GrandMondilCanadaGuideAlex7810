...
export type GrnmdlccanadguiideCategory = 'Ice' | 'Wild' | 'Sky' | 'Hidden' | 'Stays';

export type GrnmdlccanadguiideLocation = {
  id: string;
  title: string;
  category: GrnmdlccanadguiideCategory;
  province: string;
...
export const grnmdlccanadguiideLocations: GrnmdlccanadguiideLocation[] = [
  {
...
export const grnmdlccanadguiideCategoryMeta: Record<
  GrnmdlccanadguiideCategory,
  {emoji: string; pill: string; headerGradient: [string, string]}
> = {
  Ice: {emoji: '❄️', pill: '#2D5BFF', headerGradient: ['#295BFF50', '#295BFF00']},
  Wild: {emoji: '🐻', pill: '#39B36B', headerGradient: ['#39B36B45', '#39B36B00']},
  Sky: {emoji: '🌌', pill: '#8D66FF', headerGradient: ['#8D66FF45', '#8D66FF00']},
  Hidden: {emoji: '🌲', pill: '#CCB500', headerGradient: ['#CCB50040', '#CCB50000']},
  Stays: {emoji: '🛖', pill: '#FF8A3D', headerGradient: ['#FF8A3D40', '#FF8A3D00']},
};

export type GrnmdlccanadguiideExploreCategory = 'All' | GrnmdlccanadguiideCategory;

export const grnmdlccanadguiideExploreCategories: Array<{
  id: GrnmdlccanadguiideExploreCategory;
  title: string;
  emoji: string;
  gradient: [string, string];
}> = [
  {id: 'All', title: 'All', emoji: '', gradient: ['#152B1C', '#152B1C']},
  {id: 'Ice', title: 'Ice', emoji: '❄️', gradient: ['#1E63FF70', '#0A181000']},
  {id: 'Wild', title: 'Wild', emoji: '🐻', gradient: ['#39B36B60', '#0A181000']},
  {id: 'Sky', title: 'Sky', emoji: '🌌', gradient: ['#8D66FF60', '#0A181000']},
  {id: 'Hidden', title: 'Hidden', emoji: '🌲', gradient: ['#CCB50055', '#0A181000']},
  {id: 'Stays', title: 'Stays', emoji: '🛖', gradient: ['#FF8A3D55', '#0A181000']},
];
